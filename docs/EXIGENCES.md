...
| GR-21 | « Ma position » amène la carte sur elle, au zoom d'un point unique, et reste inerte tant qu'elle est inconnue                                  | `U LeafletCoordonneeSelector.test.ts`, `E e2e/gps.spec.ts`                                |
