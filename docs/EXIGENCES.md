...
| GR-11 | Cliquer la ligne d'un point amène son repère à l'écran et cale la carte dessus                                   | `U TrajetEditorScreen.test.ts`, `U LeafletCarteDesPoints.test.ts`, `E e2e/points.spec.ts` |
